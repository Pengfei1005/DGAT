...
class Dubai_CC_Dataset(Dataset):
    def __init__(self, data_path, list_path, split, max_length=27, allow_unknown=0, vocab_file=None, token_path=None):
...
if __name__ == '__main__':
    train_dataset = Dubai_CC_Dataset(data_path='/mnt/data0/qpf_4000/DGAT/data/Dubai_CC/images', list_path='/mnt/data0/qpf_4000/DGAT/data/Dubai_CC',
