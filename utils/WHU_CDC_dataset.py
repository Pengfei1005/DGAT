...
class WHU_CDC_Dataset(Dataset):
    def __init__(self, data_path, list_path, split, max_length=26, allow_unknown=0, vocab_file=None, token_path=None):
        
        self.mean = [123.6404, 118.4032, 108.3062]
        self.std = [49.7608, 48.1702, 51.4021]
        self.split = split
...
if __name__ == '__main__':
    train_dataset = WHU_CDC_Dataset(data_path='/mnt/data0/qpf_4000/DGAT/data/WHU_CDC/images', list_path='/mnt/data0/qpf_4000/DGAT/data/WHU_CDC',
